...
class Request
{
    public const http_interface = 'auto'; // 'auto': autodetect, 'curl' or 'fopen'
    public const interface_name = gapi::interface_name;
    ...
    private function fopenRequest($get_variables = null, $post_variables = null, $headers = null)
    {
        ...
        return ['body' => false !== $response ? $response : 'Request failed, consider using php5-curl module for more information.', 'code' => false !== $response ? '200' : '400'];
    }
}
