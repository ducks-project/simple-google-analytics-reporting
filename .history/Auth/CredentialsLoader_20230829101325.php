...
namespace DucksProject\Component\SimpleGoogleAnalyticsReporting\Auth;

abstract class CredentialsLoader
{
    public const TOKEN_CREDENTIAL_URI = 'https://oauth2.googleapis.com/token';
    public const ENV_VAR = 'GOOGLE_APPLICATION_CREDENTIALS';
    public const QUOTA_PROJECT_ENV_VAR = 'GOOGLE_CLOUD_QUOTA_PROJECT';
